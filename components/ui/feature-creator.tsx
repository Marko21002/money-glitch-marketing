        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:grid-cols-2 lg:items-start">
          <div className="px-6 lg:px-0 lg:pr-4 lg:pt-4">
            <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-lg">
              <h2 className="text-base font-semibold leading-7 text-white">Features for Creators</h2>
              <p className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">Empower your creativity</p>
              <p className="mt-6 text-lg leading-8 text-white">
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit perferendis suscipit eaque,
                iste dolor cupiditate blanditiis ratione.
              </p>
              <dl className="mt-10 space-y-8 text-base leading-7 text-white lg:max-w-none">
          ...
          <div className="px-6 lg:px-0 lg:pl-4 lg:pt-4">
            <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-lg">
              <h2 className="text-base font-semibold leading-7 text-white">Features for Consumers</h2>
              <p className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">Enhance your experience</p>
              <p className="mt-6 text-lg leading-8 text-white">
